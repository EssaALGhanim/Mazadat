...
export default function AdminUserDetailsDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-h-[90vh] overflow-y-auto border-[#D7E8E5] bg-[#FCFEFD] sm:max-w-2xl" dir={i18n.dir()}>
                <DialogHeader className="text-start">
                    <DialogTitle className="text-[#1A2E2C]">{t('admin.users.detailsTitle')}</DialogTitle>
