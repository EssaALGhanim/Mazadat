...
import { ChevronLeft, ChevronRight, User, Trophy, Download, Home, X, Zap, Star, Flag, MessageSquare } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#F0F2F5] dark:bg-slate-950 py-8" dir={isAr ? 'rtl' : 'ltr'}>
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <section className="mt-6">
                    <div className={`flex items-center gap-2 mb-3 ${isAr ? 'flex-row-reverse justify-end' : ''}`}>
                        <MessageSquare className="w-5 h-5 text-[#2A9D8F]" />
                        <h2 className="text-lg font-bold text-[#1A2E2C] dark:text-slate-100">
                            {t('comments.title')}
                        </h2>
                    </div>
                    <AuctionComments
                        ...
                        auctionSellerUsername={auction?.sellerName}
                    />
                </section>
            </div>
